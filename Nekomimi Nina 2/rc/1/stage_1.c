...
void
n_nn2_stage_1_init( n_nn2 *p )
{

	n_nn2_stage *s = &n_nn2_stage_1;
	...
	n_nn2_rc_load_map( @"rc/1/map/0" , &s->map );
	n_nn2_rc_load_map( @"rc/1/map/1" , &s->map_queue );
	n_nn2_rc_load_map( @"rc/1/map/2" , &s->map_dokan );
